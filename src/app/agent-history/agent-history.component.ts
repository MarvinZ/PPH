...
@Component({
  ...
  styleUrls: ['./agent-history.component.css']
})
export class AgentHistoryComponent extends Localization implements OnInit {
  ...
  public transactionTypes = [
    { value: '-1', display: 'All' },
    { value: '0', display: 'Payments' },
    { value: '1', display: 'Adjustments' }
  ];
  ...
  go() {
    ...
    this.affiliateService.GetagentHistoryReport(this.auth.currentUser.id, startDate, endDate)
      .subscribe(response => {
