...
export declare class DateRangeUtilService {
    isDateRangeValid(daterange: string, dateFormat: string, minYear: number, maxYear: number, disableUntil: IMyDate, disableSince: IMyDate, disableDates: Array<IMyDate>, disableDateRanges: Array<IMyDateRange>, monthLabels: IMyMonthLabels): IMyDateRange;
    ...
    isDisabledDay(date: IMyDate, disableUntil: IMyDate, disableSince: IMyDate, disableDates: Array<IMyDate>, disableDateRanges: Array<IMyDateRange>, preventBefore: IMyDate, preventAfter: IMyDate): boolean;
