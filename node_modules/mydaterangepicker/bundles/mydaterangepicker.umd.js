...
var DateRangeUtilService = (function () {
    ...
    DateRangeUtilService.prototype.isDateRangeValid = function (daterange, dateFormat, minYear, maxYear, disableUntil, disableSince, disableDates, disableDateRanges, monthLabels) {
    ...
    DateRangeUtilService.prototype.isDisabledDay = function (date, disableUntil, disableSince, disableDates, disableDateRanges, preventBefore, preventAfter) {
        ...
        for (var _i = 0, disableDates_1 = disableDates; _i < disableDates_1.length; _i++) {
            var d = disableDates_1[_i];
            if (d.year === date.year && d.month === date.month && d.day === date.day) {
                return true;
            }
        }
        for (var _a = 0, disableDateRanges_1 = disableDateRanges; _a < disableDateRanges_1.length; _a++) {
            var d = disableDateRanges_1[_a];
...
var MyDateRangePicker = (function () {
    ...
    MyDateRangePicker.prototype.userDateRangeInput = function (event) {
        ...
        if (event.target.value.length === 0) {
            ...
            var daterange = this.drus.isDateRangeValid(event.target.value, this.opts.dateFormat, this.opts.minYear, this.opts.maxYear, this.opts.disableUntil, this.opts.disableSince, this.opts.disableDates, this.opts.disableDateRanges, this.opts.monthLabels);
